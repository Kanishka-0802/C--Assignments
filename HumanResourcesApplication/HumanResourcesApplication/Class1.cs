...
namespace ClassLibrary1
{
    ...
    {
        Class1 GetEmployeeRecord(int employeeId);
    }

    public class MockEmployeeDataReader : IEmployeeDataReader
    {
        public Class1 GetEmployeeRecord(int employeeId)
        {
            if (employeeId == 202501)
                return new Class1 { Id = 202501, Name = "Kanishka", Role = "Developer", IsVeteran = false };
            else if (employeeId == 202502)
                return new Class1 { Id = 202502, Name = "Preethi", Role = "Consultant", IsVeteran = true };
            else if (employeeId == 202503)
                return new Class1 { Id = 202503, Name = "Sastika", Role = "Manager", IsVeteran = true };
            else if (employeeId == 202504)
                return new Class1 { Id = 202504, Name = "Mahitha", Role = "Tester", IsVeteran = false };
            else if (employeeId == 202505)
                return new Class1 { Id = 202505, Name = "Yuvarani", Role = "Manager", IsVeteran = false };
            else if (employeeId == 202506)
                return new Class1 { Id = 202506, Name = "Abirami", Role = "Developer", IsVeteran = true };
            else if (employeeId == 202507)
                return new Class1 { Id = 202507, Name = "Janani", Role = "Intern", IsVeteran = false };
            else
                return new Class1 { Id = employeeId, Name = "Unknown", Role = "Other", IsVeteran = false };
        }
    }
